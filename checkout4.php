                    ...
                    <div class="box">
                        <form method="post" action="order_success.php">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li><a href="checkout2.php?url=ch4"><i class="fa fa-truck"></i><br>選擇取貨方式</a>
                                </li>
                            ...
                            <div class="table-responsive">
                                    ...
                                    for ($i = 0; $i< count($_SESSION['Cart']); $i++){ ?>
                                     <tr>
                                            ...
                                            <td><a href="product.php?id=<?php echo $_SESSION['Cart'][$i]['products_id']; ?>"><?php echo $_SESSION['Cart'][$i]['product_name']; ?></a>
                                            </td>
                                            <td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <input type="hidden" name="order_no" value="<?php echo "ol".date('HYmdis'); ?>">
