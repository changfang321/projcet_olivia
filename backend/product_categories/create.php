...
if(isset($_POST['AddForm']) && $_POST['AddForm'] == "INSERT"){
  ...
  if(isset($_FILES['picture']['name'])){
    ...
    $file_path = '../../uploads/category/'.$_FILES['picture']['name'];
    move_uploaded_file($_FILES['picture']['tmp_name'], $file_path) ;
  }else{
    $filename = null ;
  }

  $sql= "INSERT INTO product_categories (picture,category,created_at) VALUES (:picture, :category, :created_at)";
  $sth = $db ->prepare($sql);
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="form-group form-row">
              <label class="col-sm-2 col-form-label">類別圖片</label>
              <div class="col-sm-10">
