                    ...
                    <div class="box">
                        <form method="post" action="checkout4.php">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li><a href="checkout2.php?url=ch3"><i class="fa fa-truck"></i><br>選擇取貨方式</a>
                                </li>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="checkout2.php?url=ch3" class="btn btn-default"><i class="fa fa-chevron-left"></i>上一步</a>
                                </div>
